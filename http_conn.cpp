...
// 网站的根目录
//const char* doc_root = "/home/gxy/webserver/resources"; /home/gxy/webserer/resources/index.html
const char* doc_root = "/home/gxy/webserer/resources";
...
void http_conn::init(){
    ...
    m_check_state = CHECK_STATE_REQUESTLINE; //初始化状态为解析请求的首行
    m_host = 0;
    m_checked_idx = 0;
    m_start_line =0;
    m_read_idx = 0;
...
//由线程池的工作线程调用，这是处理HTTP请求的入口函数
 void http_conn::process(){
    ...
    // printf("parse request, create ressponse\n");
